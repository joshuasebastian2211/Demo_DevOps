...
namespace SampleBoilerTemp.Web.Models.DAO
{
    ...
    public partial class CoreRequestEntities : DbContext
    {
        public CoreRequestEntities()
            : base("name=CoreRequestEntities")
        {
        }
        ...
        public virtual DbSet<RequesterDetail> RequesterDetails { get; set; }
        public virtual DbSet<SMS_Particulars> SMS_Particulars { get; set; }
        public virtual DbSet<SMS_Units> SMS_Units { get; set; }
        public virtual DbSet<StationaryRequest> StationaryRequests { get; set; }
        public virtual DbSet<StationaryRequestDetail> StationaryRequestDetails { get; set; }
